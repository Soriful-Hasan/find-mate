...
//   return storedTheme ? localStorage.getItem("theme") : "light";
// };
const Navbar = () => {
  ...
  const link = [
    <div className="flex items-center flex-col gap-4 lg:gap-6 xl:18 lg:flex-row">
      <NavLink
        className={({ isActive }) =>
          isActive
            ? " text-[#23BE0A] outline-[#23BE0A]  py-2 px-4 rounded outline-1 font-bold "
            : "text-[#131313]"
        }
        to={"/"}
      >
      ...
      <div className="navbar bg-base-100 shadow-sm">
        <div className="navbar-start">
          ...
          <div className="lg:flex item-center  items-center gap-4 hidden lg:block">
            ...
            <a className="text-sm lg:text-xl  font-semibold">Room mate</a>
          </div>
        </div>
        ...
        <div className="navbar-end  space-x-5">
            ...
            {loading ? (
              ...
              <div className="avatar">
                <div className="w-12 rounded-full ">
                  {user ? <img src={user?.photoURL} /> : <span></span>}
                </div>
              </div>
            )}
          </div>
          {loading ? (
            ...
            <>
              {user ? (
                <button
                  className="btn text-white rounded-sm bg-[#23BE0A] "
                ...
                <div className="flex gap-4">
                  ...
                  <Link
                    className="btn text-white rounded-sm bg-[#59C6D2] "
                    to={"/register"}
                  >
                    Sign Up
                  </Link>
